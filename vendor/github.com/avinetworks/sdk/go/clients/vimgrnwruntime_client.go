...
func (client *VIMgrNWRuntimeClient) GetAll(tenant ...string) ([]*models.VIMgrNWRuntime, error) {
...
func (client *VIMgrNWRuntimeClient) Get(uuid string, tenant ...string) (*models.VIMgrNWRuntime, error) {
...
func (client *VIMgrNWRuntimeClient) GetByName(name string, tenant ...string) (*models.VIMgrNWRuntime, error) {
	var obj *models.VIMgrNWRuntime
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
	err := client.aviSession.GetObjectByName("vimgrnwruntime", name, &obj, loc_tenant)
	return obj, err
}
...
func (client *VIMgrNWRuntimeClient) GetObject(tenant string, options ...session.ApiOptionsParams) (*models.VIMgrNWRuntime, error) {
	var obj *models.VIMgrNWRuntime
	loc_tenant := ""
	if tenant != "" {
		loc_tenant = tenant
	...
	err := client.aviSession.GetObject("vimgrnwruntime", loc_tenant, newOptions...)
	return obj, err
}

// Create a new VIMgrNWRuntime object
func (client *VIMgrNWRuntimeClient) Create(obj *models.VIMgrNWRuntime, tenant ...string) (*models.VIMgrNWRuntime, error) {
...
func (client *VIMgrNWRuntimeClient) Update(obj *models.VIMgrNWRuntime, tenant ...string) (*models.VIMgrNWRuntime, error) {
	var robj *models.VIMgrNWRuntime
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *VIMgrNWRuntimeClient) Patch(uuid string, patch interface{}, patchOp string, tenant ...string) (*models.VIMgrNWRuntime, error) {
	var robj *models.VIMgrNWRuntime
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *VIMgrNWRuntimeClient) Delete(uuid string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
...
func (client *VIMgrNWRuntimeClient) DeleteByName(name string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
