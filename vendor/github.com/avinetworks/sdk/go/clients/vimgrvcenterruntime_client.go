...
func (client *VIMgrVcenterRuntimeClient) GetAll(tenant ...string) ([]*models.VIMgrVcenterRuntime, error) {
...
func (client *VIMgrVcenterRuntimeClient) Get(uuid string, tenant ...string) (*models.VIMgrVcenterRuntime, error) {
...
func (client *VIMgrVcenterRuntimeClient) GetByName(name string, tenant ...string) (*models.VIMgrVcenterRuntime, error) {
	var obj *models.VIMgrVcenterRuntime
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
	err := client.aviSession.GetObjectByName("vimgrvcenterruntime", name, &obj, loc_tenant)
	return obj, err
}
...
func (client *VIMgrVcenterRuntimeClient) GetObject(tenant string, options ...session.ApiOptionsParams) (*models.VIMgrVcenterRuntime, error) {
	var obj *models.VIMgrVcenterRuntime
	loc_tenant := ""
	if tenant != "" {
		loc_tenant = tenant
	...
	err := client.aviSession.GetObject("vimgrvcenterruntime", loc_tenant, newOptions...)
	return obj, err
}

// Create a new VIMgrVcenterRuntime object
func (client *VIMgrVcenterRuntimeClient) Create(obj *models.VIMgrVcenterRuntime, tenant ...string) (*models.VIMgrVcenterRuntime, error) {
...
func (client *VIMgrVcenterRuntimeClient) Update(obj *models.VIMgrVcenterRuntime, tenant ...string) (*models.VIMgrVcenterRuntime, error) {
	var robj *models.VIMgrVcenterRuntime
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *VIMgrVcenterRuntimeClient) Patch(uuid string, patch interface{}, patchOp string, tenant ...string) (*models.VIMgrVcenterRuntime, error) {
	var robj *models.VIMgrVcenterRuntime
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *VIMgrVcenterRuntimeClient) Delete(uuid string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
...
func (client *VIMgrVcenterRuntimeClient) DeleteByName(name string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
