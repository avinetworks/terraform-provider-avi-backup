...
func (client *CloudConnectorUserClient) GetAll(tenant ...string) ([]*models.CloudConnectorUser, error) {
...
func (client *CloudConnectorUserClient) Get(uuid string, tenant ...string) (*models.CloudConnectorUser, error) {
...
func (client *CloudConnectorUserClient) GetByName(name string, tenant ...string) (*models.CloudConnectorUser, error) {
	var obj *models.CloudConnectorUser
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
	err := client.aviSession.GetObjectByName("cloudconnectoruser", name, &obj, loc_tenant)
	return obj, err
}
...
func (client *CloudConnectorUserClient) GetObject(tenant string, options ...session.ApiOptionsParams) (*models.CloudConnectorUser, error) {
	var obj *models.CloudConnectorUser
	loc_tenant := ""
	if tenant != "" {
		loc_tenant = tenant
	...
	err := client.aviSession.GetObject("cloudconnectoruser", loc_tenant, newOptions...)
	return obj, err
}

// Create a new CloudConnectorUser object
func (client *CloudConnectorUserClient) Create(obj *models.CloudConnectorUser, tenant ...string) (*models.CloudConnectorUser, error) {
...
func (client *CloudConnectorUserClient) Update(obj *models.CloudConnectorUser, tenant ...string) (*models.CloudConnectorUser, error) {
	var robj *models.CloudConnectorUser
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *CloudConnectorUserClient) Patch(uuid string, patch interface{}, patchOp string, tenant ...string) (*models.CloudConnectorUser, error) {
	var robj *models.CloudConnectorUser
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *CloudConnectorUserClient) Delete(uuid string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
...
func (client *CloudConnectorUserClient) DeleteByName(name string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
