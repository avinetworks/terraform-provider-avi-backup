...
func (client *VIMgrControllerRuntimeClient) GetAll(tenant ...string) ([]*models.VIMgrControllerRuntime, error) {
...
func (client *VIMgrControllerRuntimeClient) Get(uuid string, tenant ...string) (*models.VIMgrControllerRuntime, error) {
...
func (client *VIMgrControllerRuntimeClient) GetByName(name string, tenant ...string) (*models.VIMgrControllerRuntime, error) {
	var obj *models.VIMgrControllerRuntime
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
	err := client.aviSession.GetObjectByName("vimgrcontrollerruntime", name, &obj, loc_tenant)
	return obj, err
}
...
func (client *VIMgrControllerRuntimeClient) GetObject(tenant string, options ...session.ApiOptionsParams) (*models.VIMgrControllerRuntime, error) {
	var obj *models.VIMgrControllerRuntime
	loc_tenant := ""
	if tenant != "" {
		loc_tenant = tenant
	...
	err := client.aviSession.GetObject("vimgrcontrollerruntime", loc_tenant, newOptions...)
	return obj, err
}

// Create a new VIMgrControllerRuntime object
func (client *VIMgrControllerRuntimeClient) Create(obj *models.VIMgrControllerRuntime, tenant ...string) (*models.VIMgrControllerRuntime, error) {
...
func (client *VIMgrControllerRuntimeClient) Update(obj *models.VIMgrControllerRuntime, tenant ...string) (*models.VIMgrControllerRuntime, error) {
	var robj *models.VIMgrControllerRuntime
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *VIMgrControllerRuntimeClient) Patch(uuid string, patch interface{}, patchOp string, tenant ...string) (*models.VIMgrControllerRuntime, error) {
	var robj *models.VIMgrControllerRuntime
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *VIMgrControllerRuntimeClient) Delete(uuid string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
...
func (client *VIMgrControllerRuntimeClient) DeleteByName(name string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
