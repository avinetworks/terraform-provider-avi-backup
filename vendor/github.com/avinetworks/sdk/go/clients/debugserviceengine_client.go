...
func (client *DebugServiceEngineClient) GetAll(tenant ...string) ([]*models.DebugServiceEngine, error) {
...
func (client *DebugServiceEngineClient) Get(uuid string, tenant ...string) (*models.DebugServiceEngine, error) {
...
func (client *DebugServiceEngineClient) GetByName(name string, tenant ...string) (*models.DebugServiceEngine, error) {
	var obj *models.DebugServiceEngine
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
	err := client.aviSession.GetObjectByName("debugserviceengine", name, &obj, loc_tenant)
	return obj, err
}
...
func (client *DebugServiceEngineClient) GetObject(tenant string, options ...session.ApiOptionsParams) (*models.DebugServiceEngine, error) {
	var obj *models.DebugServiceEngine
	loc_tenant := ""
	if tenant != "" {
		loc_tenant = tenant
	...
	err := client.aviSession.GetObject("debugserviceengine", loc_tenant, newOptions...)
	return obj, err
}

// Create a new DebugServiceEngine object
func (client *DebugServiceEngineClient) Create(obj *models.DebugServiceEngine, tenant ...string) (*models.DebugServiceEngine, error) {
...
func (client *DebugServiceEngineClient) Update(obj *models.DebugServiceEngine, tenant ...string) (*models.DebugServiceEngine, error) {
	var robj *models.DebugServiceEngine
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *DebugServiceEngineClient) Patch(uuid string, patch interface{}, patchOp string, tenant ...string) (*models.DebugServiceEngine, error) {
	var robj *models.DebugServiceEngine
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *DebugServiceEngineClient) Delete(uuid string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
...
func (client *DebugServiceEngineClient) DeleteByName(name string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
