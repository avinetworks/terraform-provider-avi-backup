...
func (client *AlertSyslogConfigClient) GetAll(tenant ...string) ([]*models.AlertSyslogConfig, error) {
...
func (client *AlertSyslogConfigClient) Get(uuid string, tenant ...string) (*models.AlertSyslogConfig, error) {
...
func (client *AlertSyslogConfigClient) GetByName(name string, tenant ...string) (*models.AlertSyslogConfig, error) {
	var obj *models.AlertSyslogConfig
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
	err := client.aviSession.GetObjectByName("alertsyslogconfig", name, &obj, loc_tenant)
	return obj, err
}
...
func (client *AlertSyslogConfigClient) GetObject(tenant string, options ...session.ApiOptionsParams) (*models.AlertSyslogConfig, error) {
	var obj *models.AlertSyslogConfig
	loc_tenant := ""
	if tenant != "" {
		loc_tenant = tenant
	...
	err := client.aviSession.GetObject("alertsyslogconfig", loc_tenant, newOptions...)
	return obj, err
}

// Create a new AlertSyslogConfig object
func (client *AlertSyslogConfigClient) Create(obj *models.AlertSyslogConfig, tenant ...string) (*models.AlertSyslogConfig, error) {
...
func (client *AlertSyslogConfigClient) Update(obj *models.AlertSyslogConfig, tenant ...string) (*models.AlertSyslogConfig, error) {
	var robj *models.AlertSyslogConfig
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *AlertSyslogConfigClient) Patch(uuid string, patch interface{}, patchOp string, tenant ...string) (*models.AlertSyslogConfig, error) {
	var robj *models.AlertSyslogConfig
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *AlertSyslogConfigClient) Delete(uuid string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
...
func (client *AlertSyslogConfigClient) DeleteByName(name string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
