...
func (client *NetworkClient) GetAll(tenant ...string) ([]*models.Network, error) {
...
func (client *NetworkClient) Get(uuid string, tenant ...string) (*models.Network, error) {
...
func (client *NetworkClient) GetByName(name string, tenant ...string) (*models.Network, error) {
	var obj *models.Network
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
	err := client.aviSession.GetObjectByName("network", name, &obj, loc_tenant)
	return obj, err
}

// GetObject - Get an existing Network by filters like name, cloud, tenant
// Api creates Network object with every call.
func (client *NetworkClient) GetObject(tenant string, options ...session.ApiOptionsParams) (*models.Network, error) {
	var obj *models.Network
	loc_tenant := ""
	if tenant != "" {
		loc_tenant = tenant
	...
	err := client.aviSession.GetObject("network", loc_tenant, newOptions...)
	return obj, err
}

// Create a new Network object
func (client *NetworkClient) Create(obj *models.Network, tenant ...string) (*models.Network, error) {
...
func (client *NetworkClient) Update(obj *models.Network, tenant ...string) (*models.Network, error) {
	var robj *models.Network
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *NetworkClient) Patch(uuid string, patch interface{}, patchOp string, tenant ...string) (*models.Network, error) {
	var robj *models.Network
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *NetworkClient) Delete(uuid string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
...
func (client *NetworkClient) DeleteByName(name string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
