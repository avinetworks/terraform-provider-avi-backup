...
func (client *AlertScriptConfigClient) GetAll(tenant ...string) ([]*models.AlertScriptConfig, error) {
...
func (client *AlertScriptConfigClient) Get(uuid string, tenant ...string) (*models.AlertScriptConfig, error) {
...
func (client *AlertScriptConfigClient) GetByName(name string, tenant ...string) (*models.AlertScriptConfig, error) {
	var obj *models.AlertScriptConfig
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
	err := client.aviSession.GetObjectByName("alertscriptconfig", name, &obj, loc_tenant)
	return obj, err
}
...
func (client *AlertScriptConfigClient) GetObject(tenant string, options ...session.ApiOptionsParams) (*models.AlertScriptConfig, error) {
	var obj *models.AlertScriptConfig
	loc_tenant := ""
	if tenant != "" {
		loc_tenant = tenant
	...
	err := client.aviSession.GetObject("alertscriptconfig", loc_tenant, newOptions...)
	return obj, err
}

// Create a new AlertScriptConfig object
func (client *AlertScriptConfigClient) Create(obj *models.AlertScriptConfig, tenant ...string) (*models.AlertScriptConfig, error) {
...
func (client *AlertScriptConfigClient) Update(obj *models.AlertScriptConfig, tenant ...string) (*models.AlertScriptConfig, error) {
	var robj *models.AlertScriptConfig
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *AlertScriptConfigClient) Patch(uuid string, patch interface{}, patchOp string, tenant ...string) (*models.AlertScriptConfig, error) {
	var robj *models.AlertScriptConfig
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *AlertScriptConfigClient) Delete(uuid string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
...
func (client *AlertScriptConfigClient) DeleteByName(name string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
