...
func (client *WafPolicyClient) GetAll(tenant ...string) ([]*models.WafPolicy, error) {
...
func (client *WafPolicyClient) Get(uuid string, tenant ...string) (*models.WafPolicy, error) {
...
func (client *WafPolicyClient) GetByName(name string, tenant ...string) (*models.WafPolicy, error) {
	var obj *models.WafPolicy
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
	err := client.aviSession.GetObjectByName("wafpolicy", name, &obj, loc_tenant)
	return obj, err
}

// GetObject - Get an existing WafPolicy by filters like name, cloud, tenant
// Api creates WafPolicy object with every call.
func (client *WafPolicyClient) GetObject(tenant string, options ...session.ApiOptionsParams) (*models.WafPolicy, error) {
	var obj *models.WafPolicy
	loc_tenant := ""
	if tenant != "" {
		loc_tenant = tenant
	...
	err := client.aviSession.GetObject("wafpolicy", loc_tenant, newOptions...)
	return obj, err
}

// Create a new WafPolicy object
func (client *WafPolicyClient) Create(obj *models.WafPolicy, tenant ...string) (*models.WafPolicy, error) {
...
func (client *WafPolicyClient) Update(obj *models.WafPolicy, tenant ...string) (*models.WafPolicy, error) {
	var robj *models.WafPolicy
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *WafPolicyClient) Patch(uuid string, patch interface{}, patchOp string, tenant ...string) (*models.WafPolicy, error) {
	var robj *models.WafPolicy
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *WafPolicyClient) Delete(uuid string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
...
func (client *WafPolicyClient) DeleteByName(name string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
