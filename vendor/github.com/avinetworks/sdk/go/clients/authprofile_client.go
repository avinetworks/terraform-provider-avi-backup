...
func (client *AuthProfileClient) GetAll(tenant ...string) ([]*models.AuthProfile, error) {
...
func (client *AuthProfileClient) Get(uuid string, tenant ...string) (*models.AuthProfile, error) {
...
func (client *AuthProfileClient) GetByName(name string, tenant ...string) (*models.AuthProfile, error) {
	var obj *models.AuthProfile
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
	err := client.aviSession.GetObjectByName("authprofile", name, &obj, loc_tenant)
	return obj, err
}

// GetObject - Get an existing AuthProfile by filters like name, cloud, tenant
// Api creates AuthProfile object with every call.
func (client *AuthProfileClient) GetObject(tenant string, options ...session.ApiOptionsParams) (*models.AuthProfile, error) {
	var obj *models.AuthProfile
	loc_tenant := ""
	if tenant != "" {
		loc_tenant = tenant
	...
	err := client.aviSession.GetObject("authprofile", loc_tenant, newOptions...)
	return obj, err
}

// Create a new AuthProfile object
func (client *AuthProfileClient) Create(obj *models.AuthProfile, tenant ...string) (*models.AuthProfile, error) {
...
func (client *AuthProfileClient) Update(obj *models.AuthProfile, tenant ...string) (*models.AuthProfile, error) {
	var robj *models.AuthProfile
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *AuthProfileClient) Patch(uuid string, patch interface{}, patchOp string, tenant ...string) (*models.AuthProfile, error) {
	var robj *models.AuthProfile
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *AuthProfileClient) Delete(uuid string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
...
func (client *AuthProfileClient) DeleteByName(name string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
