...
func (client *MicroServiceGroupClient) GetAll(tenant ...string) ([]*models.MicroServiceGroup, error) {
...
func (client *MicroServiceGroupClient) Get(uuid string, tenant ...string) (*models.MicroServiceGroup, error) {
...
func (client *MicroServiceGroupClient) GetByName(name string, tenant ...string) (*models.MicroServiceGroup, error) {
	var obj *models.MicroServiceGroup
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
	err := client.aviSession.GetObjectByName("microservicegroup", name, &obj, loc_tenant)
	return obj, err
}
...
func (client *MicroServiceGroupClient) GetObject(tenant string, options ...session.ApiOptionsParams) (*models.MicroServiceGroup, error) {
	var obj *models.MicroServiceGroup
	loc_tenant := ""
	if tenant != "" {
		loc_tenant = tenant
	...
	err := client.aviSession.GetObject("microservicegroup", loc_tenant, newOptions...)
	return obj, err
}

// Create a new MicroServiceGroup object
func (client *MicroServiceGroupClient) Create(obj *models.MicroServiceGroup, tenant ...string) (*models.MicroServiceGroup, error) {
...
func (client *MicroServiceGroupClient) Update(obj *models.MicroServiceGroup, tenant ...string) (*models.MicroServiceGroup, error) {
	var robj *models.MicroServiceGroup
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *MicroServiceGroupClient) Patch(uuid string, patch interface{}, patchOp string, tenant ...string) (*models.MicroServiceGroup, error) {
	var robj *models.MicroServiceGroup
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *MicroServiceGroupClient) Delete(uuid string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
...
func (client *MicroServiceGroupClient) DeleteByName(name string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
