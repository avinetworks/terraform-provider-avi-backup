...
func (client *HealthMonitorClient) GetAll(tenant ...string) ([]*models.HealthMonitor, error) {
...
func (client *HealthMonitorClient) Get(uuid string, tenant ...string) (*models.HealthMonitor, error) {
...
func (client *HealthMonitorClient) GetByName(name string, tenant ...string) (*models.HealthMonitor, error) {
	var obj *models.HealthMonitor
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
	err := client.aviSession.GetObjectByName("healthmonitor", name, &obj, loc_tenant)
	return obj, err
}
...
func (client *HealthMonitorClient) GetObject(tenant string, options ...session.ApiOptionsParams) (*models.HealthMonitor, error) {
	var obj *models.HealthMonitor
	loc_tenant := ""
	if tenant != "" {
		loc_tenant = tenant
	...
	err := client.aviSession.GetObject("healthmonitor", loc_tenant, newOptions...)
	return obj, err
}

// Create a new HealthMonitor object
func (client *HealthMonitorClient) Create(obj *models.HealthMonitor, tenant ...string) (*models.HealthMonitor, error) {
...
func (client *HealthMonitorClient) Update(obj *models.HealthMonitor, tenant ...string) (*models.HealthMonitor, error) {
	var robj *models.HealthMonitor
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *HealthMonitorClient) Patch(uuid string, patch interface{}, patchOp string, tenant ...string) (*models.HealthMonitor, error) {
	var robj *models.HealthMonitor
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *HealthMonitorClient) Delete(uuid string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
...
func (client *HealthMonitorClient) DeleteByName(name string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
