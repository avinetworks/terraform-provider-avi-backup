...
func (client *VSDataScriptSetClient) GetAll(tenant ...string) ([]*models.VSDataScriptSet, error) {
...
func (client *VSDataScriptSetClient) Get(uuid string, tenant ...string) (*models.VSDataScriptSet, error) {
...
func (client *VSDataScriptSetClient) GetByName(name string, tenant ...string) (*models.VSDataScriptSet, error) {
	var obj *models.VSDataScriptSet
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
	err := client.aviSession.GetObjectByName("vsdatascriptset", name, &obj, loc_tenant)
	return obj, err
}
...
func (client *VSDataScriptSetClient) GetObject(tenant string, options ...session.ApiOptionsParams) (*models.VSDataScriptSet, error) {
	var obj *models.VSDataScriptSet
	loc_tenant := ""
	if tenant != "" {
		loc_tenant = tenant
	...
	err := client.aviSession.GetObject("vsdatascriptset", loc_tenant, newOptions...)
	return obj, err
}

// Create a new VSDataScriptSet object
func (client *VSDataScriptSetClient) Create(obj *models.VSDataScriptSet, tenant ...string) (*models.VSDataScriptSet, error) {
...
func (client *VSDataScriptSetClient) Update(obj *models.VSDataScriptSet, tenant ...string) (*models.VSDataScriptSet, error) {
	var robj *models.VSDataScriptSet
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *VSDataScriptSetClient) Patch(uuid string, patch interface{}, patchOp string, tenant ...string) (*models.VSDataScriptSet, error) {
	var robj *models.VSDataScriptSet
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *VSDataScriptSetClient) Delete(uuid string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
...
func (client *VSDataScriptSetClient) DeleteByName(name string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
