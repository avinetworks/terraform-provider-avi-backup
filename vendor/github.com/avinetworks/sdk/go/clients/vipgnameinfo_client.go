...
func (client *VIPGNameInfoClient) GetAll(tenant ...string) ([]*models.VIPGNameInfo, error) {
...
func (client *VIPGNameInfoClient) Get(uuid string, tenant ...string) (*models.VIPGNameInfo, error) {
...
func (client *VIPGNameInfoClient) GetByName(name string, tenant ...string) (*models.VIPGNameInfo, error) {
	var obj *models.VIPGNameInfo
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
	err := client.aviSession.GetObjectByName("vipgnameinfo", name, &obj, loc_tenant)
	return obj, err
}

// GetObject - Get an existing VIPGNameInfo by filters like name, cloud, tenant
// Api creates VIPGNameInfo object with every call.
func (client *VIPGNameInfoClient) GetObject(tenant string, options ...session.ApiOptionsParams) (*models.VIPGNameInfo, error) {
	var obj *models.VIPGNameInfo
	loc_tenant := ""
	if tenant != "" {
		loc_tenant = tenant
	...
	err := client.aviSession.GetObject("vipgnameinfo", loc_tenant, newOptions...)
	return obj, err
}

// Create a new VIPGNameInfo object
func (client *VIPGNameInfoClient) Create(obj *models.VIPGNameInfo, tenant ...string) (*models.VIPGNameInfo, error) {
...
func (client *VIPGNameInfoClient) Update(obj *models.VIPGNameInfo, tenant ...string) (*models.VIPGNameInfo, error) {
	var robj *models.VIPGNameInfo
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *VIPGNameInfoClient) Patch(uuid string, patch interface{}, patchOp string, tenant ...string) (*models.VIPGNameInfo, error) {
	var robj *models.VIPGNameInfo
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *VIPGNameInfoClient) Delete(uuid string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
...
func (client *VIPGNameInfoClient) DeleteByName(name string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
