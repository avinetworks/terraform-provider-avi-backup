...
func (client *PoolGroupClient) GetAll(tenant ...string) ([]*models.PoolGroup, error) {
...
func (client *PoolGroupClient) Get(uuid string, tenant ...string) (*models.PoolGroup, error) {
...
func (client *PoolGroupClient) GetByName(name string, tenant ...string) (*models.PoolGroup, error) {
	var obj *models.PoolGroup
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
	err := client.aviSession.GetObjectByName("poolgroup", name, &obj, loc_tenant)
	return obj, err
}

// GetObject - Get an existing PoolGroup by filters like name, cloud, tenant
// Api creates PoolGroup object with every call.
func (client *PoolGroupClient) GetObject(tenant string, options ...session.ApiOptionsParams) (*models.PoolGroup, error) {
	var obj *models.PoolGroup
	loc_tenant := ""
	if tenant != "" {
		loc_tenant = tenant
	...
	err := client.aviSession.GetObject("poolgroup", loc_tenant, newOptions...)
	return obj, err
}

// Create a new PoolGroup object
func (client *PoolGroupClient) Create(obj *models.PoolGroup, tenant ...string) (*models.PoolGroup, error) {
...
func (client *PoolGroupClient) Update(obj *models.PoolGroup, tenant ...string) (*models.PoolGroup, error) {
	var robj *models.PoolGroup
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *PoolGroupClient) Patch(uuid string, patch interface{}, patchOp string, tenant ...string) (*models.PoolGroup, error) {
	var robj *models.PoolGroup
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *PoolGroupClient) Delete(uuid string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
...
func (client *PoolGroupClient) DeleteByName(name string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
