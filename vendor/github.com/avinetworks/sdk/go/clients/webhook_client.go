...
func (client *WebhookClient) GetAll(tenant ...string) ([]*models.Webhook, error) {
...
func (client *WebhookClient) Get(uuid string, tenant ...string) (*models.Webhook, error) {
...
func (client *WebhookClient) GetByName(name string, tenant ...string) (*models.Webhook, error) {
	var obj *models.Webhook
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
	err := client.aviSession.GetObjectByName("webhook", name, &obj, loc_tenant)
	return obj, err
}

// GetObject - Get an existing Webhook by filters like name, cloud, tenant
// Api creates Webhook object with every call.
func (client *WebhookClient) GetObject(tenant string, options ...session.ApiOptionsParams) (*models.Webhook, error) {
	var obj *models.Webhook
	loc_tenant := ""
	if tenant != "" {
		loc_tenant = tenant
	...
	err := client.aviSession.GetObject("webhook", loc_tenant, newOptions...)
	return obj, err
}

// Create a new Webhook object
func (client *WebhookClient) Create(obj *models.Webhook, tenant ...string) (*models.Webhook, error) {
...
func (client *WebhookClient) Update(obj *models.Webhook, tenant ...string) (*models.Webhook, error) {
	var robj *models.Webhook
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *WebhookClient) Patch(uuid string, patch interface{}, patchOp string, tenant ...string) (*models.Webhook, error) {
	var robj *models.Webhook
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
...
func (client *WebhookClient) Delete(uuid string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
...
func (client *WebhookClient) DeleteByName(name string, tenant ...string) error {
	loc_tenant := ""
	if len(tenant) != 0 {
		loc_tenant = tenant[0]
	}
